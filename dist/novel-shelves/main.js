...
var map = {
	...
	"./container/container.module": [
		...
		"container-container-module~search-search-module",
		"container-container-module"
	],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _common_globals_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common/globals.service */ "./src/app/common/globals.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(changeRef, globals) {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _common_globals_service__WEBPACK_IMPORTED_MODULE_1__["GlobalsService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _core_http_error_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/http/error.interceptor */ "./src/app/core/http/error.interceptor.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _core_http_error_interceptor__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"], multi: true },
            ],
...
/***/ "./src/app/common/globals.service.ts":
/*!*******************************************!*\
  !*** ./src/app/common/globals.service.ts ***!
  \*******************************************/
...
var ErrorInterceptor = /** @class */ (function () {
    function ErrorInterceptor(injector, globals) {
        this.injector = injector;
        this.globals = globals;
    }
    ErrorInterceptor.prototype.handleData = function (event) {
        // 业务处理：一些通用操作
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        var _this = this;
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (event) {
            // 允许统一对请求错误处理，这是因为一个请求若是业务上错误的情况下其HTTP请求的状态是200的情况下需要
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"] && event.status === 200) {
                return _this.handleData(event);
            }
            // 若一切都正常，则后续操作
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(event);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleData(err); }));
    };
    ErrorInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"],
            _common_globals_service__WEBPACK_IMPORTED_MODULE_4__["GlobalsService"]])
    ], ErrorInterceptor);
...
module.exports = __webpack_require__(/*! /Users/qiuziz/Documents/workSpace/novel-shelves/src/main.ts */"./src/main.ts");
